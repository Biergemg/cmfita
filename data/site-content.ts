  ...
  es: [
    {
      ...
      gallery: [
        { src: "/portfolio-estructural.jpg", alt: "Estructuras metálicas fabricadas y pintadas" },
        { src: "/portfolio-recubrimiento.jpg", alt: "Recubrimiento anticorrosivo en paneles estructurales" },
      ],
    ...
    },
    {
      ...
      gallery: [
        { src: "/portfolio-civil-obra.jpg", alt: "Frente de construcción civil FITA en sitio industrial" },
        { src: "/portfolio-civil-resultado.jpg", alt: "Caseta terminada en instalaciones industriales" },
      ],
  ...
  en: [
    {
      ...
      gallery: [
        { src: "/portfolio-estructural.jpg", alt: "Fabricated and painted structural steel frames" },
        { src: "/portfolio-recubrimiento.jpg", alt: "Anticorrosion coating on structural panels" },
      ],
    ...
    },
    {
      ...
      gallery: [
        { src: "/portfolio-civil-obra.jpg", alt: "FITA civil construction front at industrial site" },
        { src: "/portfolio-civil-resultado.jpg", alt: "Completed guardhouse at industrial facilities" },
      ],
...
export const teamMembers: Record<Locale, TeamMember[]> = {
  es: [
    ...
    },
    {
      ...
      image: "/overview-fabricacion.jpg",
    },
  ],
  en: [
    {
