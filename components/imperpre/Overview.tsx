      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-12 text-center">
          ...
          <div className="grid w-full gap-4 md:grid-cols-2 xl:grid-cols-3">
            {stats.map((stat) => (
              <div key={stat.label} className="overview-elem premium-card p-6 text-left">
                <p className="text-2xl text-steel-light">{stat.value}</p>
        ...
        <div className="w-full mt-4">
          <div className="relative h-[400px] overflow-hidden rounded-sm border border-industrial-800 shadow-2xl md:h-[600px]">
            ...
            <Image
              src="/crane.png"
              alt="Problemas en cubierta de concreto"
              fill
        ...
        <Button variant="outline" onClick={() => { trackWhatsappClick("problem-section"); window.open(getWhatsappUrl(), "_blank", "noopener,noreferrer"); }}>
          {t("cta")}
        </Button>
      </div>
    </Section>
